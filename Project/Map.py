        ...
        if stage == 1:
            ...
            for i in range(Macro.tile_wnumber):
                for j in range(Macro.tile_hnumber):
                    self.blocks += [Block.Block(Macro.tile_size/2 + Macro.tile_size * i,Macro.tile_size/2 + Macro.tile_size*j + j * 70)]
            ...
            self.ladders = [Ladder() for i in range(0)]
            for j in range(Macro.tile_hnumber):
                self.blocks += [Block.Block(Macro.tile_size / 2 + Macro.tile_size * 100,
                                            Macro.tile_size / 2 + Macro.tile_size * j + j * 70)]
